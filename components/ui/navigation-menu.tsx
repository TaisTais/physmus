...
const navigationMenuTriggerStyle = cva(
  "group inline-flex rounded-full px-5 py-2 hover:bg-hover focus:text-accent-foreground disabled:pointer-events-none text-base font-semibold navmenu-header text-primary-foreground data-[active]:bg-hover data-[state=open]:bg-hover"
)
