...
export default function Hero({
  ...
  return (
    <>
      <div className="lg:mb-32 mb-16 relative lg:min-h-[95vh] sm:min-h-[80vh] min-h-[95vh] flex items-center justify-center bg-accent">
        <div className="sm:w-4/5 container flex lg:flex-row flex-col h-auto pt-10"> 
          <div className="flex flex-col lg:gap-8 gap-3 lg:max-w-[45%] lg:mt-16 mt-6 z-20 lg:text-left text-center">
            <h1 className="2xl:text-5xl xl:text-4xl sm:text-3xl text-2xl font-bold !leading-snug text-accent-sfu drop-shadow">Виртуальный музей спорта СФУ</h1>
