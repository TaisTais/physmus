...
import { getGtoNorms } from '@/lib/queries/gto';
import { cn } from '@/lib/utils';
import { File } from 'lucide-react';
import Link from 'next/link';
import React from 'react'

export default async function GtoNorms() {
    ...
    return (
        <div className='sm:w-4/5 container my-16'>
            <Breadcrumbs data={[
                { title: "ГТО", slug: "gto" },
                { title: "Нормы комплекса ГТО", slug: "norms" }
            ]}/>

            <h1 className='font-bold lg:text-2xl text-lg'>Нормы комплекса ГТО</h1>
